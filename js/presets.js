...
// 一番良い音に聞こえてしまう。作り直す前は 6.5dB 開いていた。
//
// 実測（120 秒平均、ゆらぎ 0）: -18.9 / -20.4 / -19.1 / -19.9 / -19.3dB。
// ゆらぎを戻すと -19.6 / -17.7 / -19.5 / -19.1 / -20.1dB。
// **同じ設定を測り直しても 1〜2dB 動く**ので、ここから先は詰められない
// （粒と鐘の間隔が乱数で、一番遅いゆらぎが 10 分近くあるため）。
//
